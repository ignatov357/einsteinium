...
TESTCOIN_ROOT=$(pwd)
BOOST_PREFIX="${TESTCOIN_ROOT}/boost"
...
with many 'local symbol discarded' errors:
    ...
    local symbol 150: discarded in section `.text._ZN10tinyformat6detail14FormatIterator6finishEv' from libtestcoin_util.a(libtestcoin_util_a-random.o)
    local symbol 151: discarded in section `.text._ZN10tinyformat6detail14FormatIterator21streamStateFromFormatERSoRjPKcii' from libtestcoin_util.a(libtestcoin_util_a-random.o)
    local symbol 152: discarded in section `.text._ZN10tinyformat6detail12convertToIntIA13_cLb0EE6invokeERA13_Kc' from libtestcoin_util.a(libtestcoin_util_a-random.o)
